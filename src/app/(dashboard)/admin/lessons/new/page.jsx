...
import { createLesson, getSubjects, getModules } from '@/app/actions/lessons'
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-slate-700">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">📝 Create New Lesson</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                {modules
                  .filter(m => !selectedSubject || m.subject_id === selectedSubject)
                  .map((module) => (
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Order (Optional)</label>
              <input
                type="number"
                name="orderNum"
                defaultValue="0"
